        ...
        <main class="container">
                            ...
                            <div class="d-flex flex-column flex-md-row align-items-center mt-2 mt-md-0">
                                <?php if ($selectedComponent): ?>
                                    <div class="d-flex gap-2">
                                        <form method="post" action="lib/_remove_component.php" style="display: inline;">
            ...
            <script>
                document.getElementById('addToCartButton').addEventListener('click', function() {
                    ...
                    xhr.open('POST', 'lib/_buildsetToCart.php', true);
...
function modalFetchItems(componentName, tableName) {
	...
	fetch(`lib/_fetch_items.php?table=${tableName}`)
		.then(response => {
